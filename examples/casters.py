import json
import typing
from betterconf import betterconf, field, JSONProvider, AbstractCaster, ImpossibleToCastError
...
pretend_config = json.dumps({"id": 14, "user": {"login": "admin", "password": "admin", "user_id": 1}})
